...
class UI(QMainWindow,):
    def __init__(self):
        ...
        self.resize(680,480)
        self.setWindowIcon(QtGui.QIcon('./fuc.ico'))
        ...
        self.turn_button = QAction(QIcon('./fuc.ico'),'Turn',self)
        self.back_button = QAction(QIcon('./fuc.ico'),'Back',self)
        self.next_button = QAction(QIcon('./fuc.ico'),'Forward',self)
        self.stop_button = QAction(QIcon('./fuc.ico'),'Stop',self)
        self.reload_button = QAction(QIcon('./fuc.ico'),'Reload',self)
        self.add_button = QAction(QIcon('./fuc.ico'),'Addpage',self)
