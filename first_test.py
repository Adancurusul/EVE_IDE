...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionServer_data = QtWidgets.QAction(MainWindow)
        self.actionServer_data.setCheckable(True)
        self.actionServer_data.setChecked(True)
        self.actionServer_data.setObjectName("actionServer_data")
        self.actionPRV332_IDE = QtWidgets.QAction(MainWindow)
        self.actionPRV332_IDE.setObjectName("actionPRV332_IDE")
        self.actionChoose_GCC_toolchain = QtWidgets.QAction(MainWindow)
        self.actionChoose_GCC_toolchain.setObjectName("actionChoose_GCC_toolchain")
        self.actionPRV464_asemble_only = QtWidgets.QAction(MainWindow)
        self.actionPRV464_asemble_only.setObjectName("actionPRV464_asemble_only")
        ...
        self.menuView.addAction(self.actionServer_data)
        ...
        self.menuSettings.addAction(self.actionChoose_GCC_toolchain)
        ...
        self.menuNew_Project.addAction(self.actionPRV464_asemble_only)
        ...
        self.menuTools.addAction(self.actionPRV332_IDE)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionServer_data.setText(_translate("MainWindow", "Server data"))
        self.actionPRV332_IDE.setText(_translate("MainWindow", "PRV332_IDE"))
        self.actionChoose_GCC_toolchain.setText(_translate("MainWindow", "Choose GCC toolchain"))
        self.actionPRV464_asemble_only.setText(_translate("MainWindow", "PRV464 asemble only"))
import icons_rc
